...
public class KMeansCut {
    ...
    public static void main(String[] args) {
        try {
            ...
            KMeansCut.fillImageEdges(graph, imgSigma2);
            System.out.println("\tFilling Source edges...");
            KMeansCut.fillSourceEdges(graph,kavgs[0],srcSigma2);
            System.out.println("\tFilling Sink edges...");
            KMeansCut.fillSinkEdges(graph,kavgs[1],sinkSigma2);
