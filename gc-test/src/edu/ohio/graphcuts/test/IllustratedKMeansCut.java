 ...
 * @author david
 */
public class IllustratedKMeansCut {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Output directory for progress will be "+outdir);
            ...
            IllustratedKMeansCut.fillImageEdges(graph, imgSigma2);
            System.out.println("\tFilling Source edges...");
            IllustratedKMeansCut.fillSourceEdges(graph,kavgs[0],srcSigma2);
            System.out.println("\tFilling Sink edges...");
            IllustratedKMeansCut.fillSinkEdges(graph,kavgs[1],sinkSigma2);



            System.out.println("Starting normal BK cut...");
            IllustratedBKTreeCut bk = new IllustratedBKTreeCut(graph);
            IllustratedKMeansCut.cutAndResults(graph,bk,file,"bk");

        } catch (IOException ex) {
            ex.printStackTrace();
            Logger.getLogger(IllustratedKMeansCut.class.getName()).log(Level.SEVERE, null, ex);
        }
