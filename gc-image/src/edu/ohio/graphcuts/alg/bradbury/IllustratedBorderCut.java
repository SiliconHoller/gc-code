 ...
 * graph cut on the given ImageGraph via IllustratedBorderCut algorithm.</p>
 ...
 * @author david
 */
public class IllustratedBorderCut extends BorderCut implements IllustratedGraphCut {
    ...
    /**
     * Constructor for the IllustratedBorderCut implementation.
     * @param graph The ImageGraph instance which the algorithm will process.
     */
    public IllustratedBorderCut(ImageGraph graph) {
        super(graph);
        ill = new Illustrator();
        imglistener = ill;
    }
