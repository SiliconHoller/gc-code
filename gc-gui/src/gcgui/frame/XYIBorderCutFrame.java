 ...
 * @author david
 */
public class XYIBorderCutFrame extends javax.swing.JFrame {
    ...
    private class AnalysisRunner implements Runnable {
        ...
        public void run() {
            ...
            //XYGrayFeatures feat = new XYGrayFeatures(graph);
            //KMeans km = new XYGrayKMeans(feat.getFeatures(),3);
            KMeans km = new XYGraySquaredKMeans(graph);
            if (km.analyze()) {
