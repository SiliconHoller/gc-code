...
public class CutImage {
    ...
    public CutImage(File imgFile) {
        type = PHOTOFILE;
        this.baseFile = imgFile.getAbsolutePath();
        stripSuffix();
    }
    ...
    public CutImage getKName(int k) {
        String kname = baseFile+"K"+Integer.toString(k);
        return new CutImage(kname, CutImage.PHOTOFILE);
    }
